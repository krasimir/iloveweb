(()=>{var S={html:C,css:H,javascript:b},E=10,d={questions:[],load({lang:e,tasks:t}){t.forEach(o=>{this.questions.push({lang:e,question:o})})},initQuestions(){let e=this.questions.length,t;for(;e!=0;)t=Math.floor(Math.random()*e),e--,[this.questions[e],this.questions[t]]=[this.questions[t],this.questions[e]];this.questions=this.questions.slice(0,E)},check(e,t,o,i){let{lang:s,question:r}=this.questions[t],n=S[s]?S[s]:b;try{r.validator(n(e))&&o()}catch(u){i(O(u.toString().replace(/</gi,"&lt;")))}},html2CodeText(e){return"<code>"+e.replace(/</g,"&lt;").replace(/ /g,"&nbsp;").replace(/\n/g,`
...
#iloveweb #web #platform`)}var F=["/js/cssparser.min.js","/js/html2json.js","/js/htmlparser.min.js","/js/lodash.min.js","/js/parsel.js","/js/specificity.js","https://cdnjs.cloudflare.com/ajax/libs/lottie-web/5.9.6/lottie.min.js","https://cdnjs.cloudflare.com/ajax/libs/gsap/3.11.3/gsap.min.js","/imgs/Cycle_custom_icon.json"];async function R(e){let t=0;p({content:`
    ...
    `}),$(".loader"),await Promise.all(e.map(async o=>{await q(o),t+=1,a(".value").style.width=`width:${Math.ceil(t/e.length*100)}%;`})),gsap.to(".loader",{y:"-100px",opacity:0,ease:"back.in(1.7)",onComplete:()=>{typeof _<"u"&&(window.get=_.get),l.initQuestions(),D()}})}function D(){p({content:`
