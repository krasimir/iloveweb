(()=>{var q={html:C,css:H,javascript:b},k=10,d={questions:[],load({lang:e,tasks:t}){t.forEach(o=>{this.questions.push({lang:e,question:o})})},initQuestions(){this.questions.find(o=>o.question.only===!0)&&(this.questions=this.questions.filter(o=>o.question.only));let e=this.questions.length,t;for(;e!=0;)t=Math.floor(Math.random()*e),e--,[this.questions[e],this.questions[t]]=[this.questions[t],this.questions[e]];this.questions=this.questions.slice(0,k),console.log(`Questions in total: ${this.questions.length}`),this.questions.forEach(o=>console.log(o.question.text))},check(e,t,o,i){let{lang:s,question:r}=this.questions[t],n=q[s]?q[s]:b;try{r.validator(n(e))&&o()}catch(u){i(O(u.toString().replace(/</gi,"&lt;")))}},html2CodeText(e){return"<code>"+e.replace(/</g,"&lt;").replace(/ /g,"&nbsp;").replace(/\n/g,`
