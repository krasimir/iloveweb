...
&nbsp;&nbsp;}&nbsp;
        ...
        `)()}},{text:'Write a JavaScript function with name "test" that returns "iloveweb".',validator(t){return"iloveweb"===new Function(`
          ${t};
          return test();
        `)()}},{text:'Write a JavaScript function called "calculate". It will receive the array:<code>[10, 2, 89]</code>Your function should calculate the sum of all the numbers and return it.',validator(t){return 101===new Function(`
          ${t};
